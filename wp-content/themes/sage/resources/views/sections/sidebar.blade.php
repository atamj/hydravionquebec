...
<div @click="sidebarOpen = !sidebarOpen" id="sidebarform-toggle"
     class="cursor-pointer fixed bottom-0 left-0 w-full z-[99999] flex items-center justify-between gap-x-[30px] shadow-inner md:hidden" style="background-color: #E4544C">
...
<aside
    ...
    @include('partials.sections.sidebar-map')
