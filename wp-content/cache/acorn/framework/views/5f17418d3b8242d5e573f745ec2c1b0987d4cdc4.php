...
>
    ...
    <img src="<?php echo e(asset('images/default.webp')); ?>"
    ...
    <div class="overflow-y-scroll w-full max-h-screen px-6 py-12 ">
        <div class="relative z-20 text-center w-full   max-w-screen-md mx-auto ">
            <h2 class="font-semibold text-5xl text-white"><?php echo e(__('Contact us', 'ng')); ?></h2>
            <p class="mt-4 mb-12 text-white"><?php echo e(__('Have a question? Feel free to contact us', 'ng')); ?></p>
...
<?php /**PATH /var/www/vhosts/hydravionquebec.com/httpdocs/wp-content/themes/sage/resources/views/partials/sections/contact-modal.blade.php ENDPATH**/ ?>