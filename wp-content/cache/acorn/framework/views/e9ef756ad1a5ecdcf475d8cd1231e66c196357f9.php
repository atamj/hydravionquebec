<footer class="overflow-hidden transition-[padding-left] ease-in-out duration-300 mt-auto flex-0 relative pb-[40px]"
    ...
    <img src="<?php echo e(asset('images/bg-footer.png')); ?>" class="z-[1] absolute  h-full w-screen object-cover" alt=""
    ...
    <div
        ...
        <div class="flex flex-col gap-y-8">
            <a class="text-sm leading-6 " href="<?php echo e(get_current_language_code() == 'fr' ? '/' : '/en'); ?>">
                <?php if(get_field('logo_light', 'option')): ?>
                    <img decoding="async" loading="lazy" width="250" src="<?php echo e(get_field('logo_light', 'option')); ?>"
        ...
        <div class="flex gap-x-12 gap-y-8 flex-col lg:flex-row lg:justify-between lg:ml-auto">
            <?php echo e(wp_nav_menu([
                ...
                'container' => 'ul',
                'menu_id' => 'footer-menu',
                'menu_class' => 'flex-wrap text-white gap-x-4 flex lg:flex-col leading-loose px-lg-10 mr-auto',
            ])); ?>
    ...
    <div
        ...
        <a href="#nous-joindre"
           class="text-sm text-left leading-6 text-white hover:text-secondary"><?php echo e(__('Contact us', 'ng')); ?></a>
        <p class="text-sm leading-6 text-white"><?php echo '@' . date('Y') . '&nbsp;' . __('Hydravion Québec - All rights reserved', 'ng'); ?> </p>
        <a class="text-sm leading-6 text-white hover:text-secondary flex"
           href="https://hebertcommunication.com">DESIGN&nbsp;+&nbsp;WEB&nbsp;→
            <img decoding="async" loading="lazy" width="24" height="24"
                 style="float:right;width: 24px;margin-left: 10px;" src="<?php echo e(asset('images/hebert.png')); ?>"
...
<?php echo $__env->make('partials.sections.contact-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /var/www/vhosts/hydravionquebec.com/httpdocs/wp-content/themes/sage/resources/views/sections/footer.blade.php ENDPATH**/ ?>