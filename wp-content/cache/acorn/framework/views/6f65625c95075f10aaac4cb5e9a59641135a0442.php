...
>
	<nav class="relative px-6 py-4 flex justify-between items-center h-[75px]">
		<a class="text-3xl font-bold leading-none" href="<?php echo e(get_current_language_code() == 'fr' ? '/' : '/en'); ?>">
			<?php if(get_field('logo_light', 'option')): ?>
				<img decoding="async" loading="lazy" width="150" src="<?php echo e(get_field('logo_light', 'option')); ?>"
...
<?php /**PATH /var/www/vhosts/hydravionquebec.com/httpdocs/wp-content/themes/sage/resources/views/sections/header.blade.php ENDPATH**/ ?>